...
public class TUIdemo extends TApplication {
    ...
    private void initializeBankData() {
        Bank.addCustomer("Oleg", "Ivanenko");
        Customer oleg = Bank.getCustomer(1);
        oleg.addAccount(new SavingsAccount(12000.00, 0.01));

        Bank.addCustomer("Sofia", "Leleka");
        Customer sofia = Bank.getCustomer(2);
        sofia.addAccount(new CheckingAccount(8000.00, 50.00));
    }
}
